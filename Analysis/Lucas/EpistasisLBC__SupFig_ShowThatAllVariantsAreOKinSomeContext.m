...
for SegN = 1:12
    fprintf('%d... ',SegN);tic; 
    T = EpistasisLBC__LoadData_FindVariableRegion_GenSparseMatrix( SegN , 'ONLY_NATLIB_FLAG',false , 'ONLY_LIB_FLAG',false , 'ONLY_MIDDLE_FLAG',false) ; 
...
save('EpistasisLBC__SupFig_ShowThatAllVariantsAreOKinSomeContext____nofilter.mat')
