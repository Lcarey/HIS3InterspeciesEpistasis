...
for I = idxs_to_plot
    ...
    axis tight;
    plot( X( Q.IntermediateStates_idx{I}) , Y( Q.IntermediateStates_idx{I}) , '.');
    plot( X( Q.Seq1_idx(I)) , Y( Q.Seq1_idx(I) ) ,'ok','MarkerFaceColor','g');
    plot( X( Q.Seq2_idx(I)) , Y( Q.Seq2_idx(I) ) ,'ok','MarkerFaceColor','r');
    set(gca,'xtick',[]);
    set(gca,'ytick',[]);
    ...
    title( sprintf('%0.0f%% %0.0f%%  %0.0f%% ' , DS.IntermediateStates_PctUnfit(I)  , DS.IntermediateStates_PctIntfit(I) , DS.IntermediateStates_PctFit(I)  ) );
